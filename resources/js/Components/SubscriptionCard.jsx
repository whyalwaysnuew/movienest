...
const SubscriptionCard = ({isPremium, id, name, price, durationInMonth, features, onSelectSubscription}) => {
    return (
        <>
            {/* Basic */}
            {!isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#9b9a9a] rounded-[26px] text-black w-[300px] h-[max-content]">
                    <div>
                    ...
                    <div>
                        <PrimaryButton
                            ...
                            className="rounded-2xl w-full border border-gray-400 py-[13px] text-center"
                        >
            ...
            {isPremium && (
                <div className="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-white w-[300px] bg-black">
                    ...
                    <div>
                        <PrimaryButton onClick={onSelectSubscription} className="rounded-2xl bg-alerange py-[13px] text-center w-full">
